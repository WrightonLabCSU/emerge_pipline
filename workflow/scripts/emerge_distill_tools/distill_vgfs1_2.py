...
from mag_annotator.utils1_2 import get_ids_from_row, get_ids_from_annotation, get_ordered_uniques
...
# TODO check the default agruments, comand should match the dir
@click.command()
...
@click.option("--replace_forms/--combine_forms", default=False,
              ...
              " form used for the distillate with your own. Note"
...
def summarize_vgfs(input_file:str, output_dir:str,
                   groupby_column:str='scaffold', max_auxiliary_score=3,
